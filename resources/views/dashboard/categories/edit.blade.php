<div class="col-lg-12">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="name"
            required autofocus value="{{ old('category', $category->name) }}">
        @error('category')
    ...
    <button type="submit" class="btn btn-primary" onclick="update({{ $category->id }})">Update
        Category</button>
    {{-- </form> --}}
