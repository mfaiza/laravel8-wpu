...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">List Categories, {{ auth()->user()->name }}</h1>
    </div>
                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="updateCategory({{ $category->id }})" class="badge bg-warning "><span
...
<script>
    ...
    function createCategory() {
        $.get("{{ url('/dashboard/categories/create') }}", {}, function(
            data, status) {
